    ...
    public function mount()
    {
        ...
        $this->sm_credit = [
            ...
            'student_transactions'=>$this->fair->schoolCreditEarned()
                ->whereRelation('pointType','source_id',\AppConst::SM_POINT_TYPE_STUDENT_ACTIVITY)->count(),
            'event_transactions'=>$this->fair->schoolCreditEarned()
                ->whereRelation('pointType','source_id',\AppConst::SM_POINT_TYPE_SCHOOL_EVENTS)->count(),
        ];
