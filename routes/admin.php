    ...
    ->name('admin.')->group(function () {
        ...
        Route::middleware('school-selected')->group(function (){
            ...
            Route::name('school.')->prefix('school')->group(function () {
                ...
                Route::view('invite-to-event', 'pages.school.school-invite-to-event' )->name('inviteToEvent');
                ...
                Route::name('statistics.')->prefix('statistics')->group(function (){
                    ...
                    Route::name('universities.')->prefix('universities')->group(function (){
                        Route::view('/','pages.statistics.universities.students-universities-list')->name('list');
                    ...
                    Route::name('majors.')->prefix('majors')->group(function (){
                        Route::view('/','pages.statistics.majors.students-majors-statistic')->name('list');
                    ...
                    Route::name('destinations.')->prefix('destinations')->group(function (){
                        Route::view('list','pages.statistics.destinations.list-of-destinations-selected-by-students')->name('list');
                ...
                Route::name('join.')->prefix('join')->group(function (){
                    ...
                    Route::name('universityEvents.')->prefix('university-events')->group(function (){
                        Route::view('open-day','pages.join-university.upcoming-university-open-day')->name('openDay');
                        Route::view('workshop','pages.join-university.upcoming-university-workshop')->name('workshop');
                        Route::view('student-for-a-day','pages.join-university.upcoming-university-student-for-a-day')->name('studentForADay');
                        Route::view('compitition','pages.join-university.upcoming-university-compitition')->name('compitition');
                    });
                    //Student Tour
