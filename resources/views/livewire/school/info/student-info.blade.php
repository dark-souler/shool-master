                ...
                <div class="card-body">
                    <div class="w-100">
                        ...
                        @php
                            ...
                            * @var \App\Models\General\Curriculum $curriculum
                            * @var \App\Models\General\FeeRange $fee_range
                            */
                        @endphp
                        <form class="mt-3" method="post" wire:submit.prevent="save">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <select class="h-100 text-start form-control input-field"
                                            id="curriculum_id" name="curriculum_id" aria-label=""
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="h-100">
                                        <input type="text" class="form-control input-field"
                                               name="number_grade12" id="number_grade12"
                                               wire:model.lazy="number_grade12"
                                ...
                                <div class="col-lg-6 mobile-marg-2">
                                    <div class="h-100">
                                        <select class="h-100 text-start form-control input-field"
                                                id="fees_grade12" name="fees_grade12" wire:model="fees_grade12"
                                                aria-label="">
                                            <option value="">@lang('Grade 12 Fee')</option>
                                            @foreach ($fee_ranges as $fee_range)
                                                <option value="{{ $fee_range->id }}">
                                                    {{ $fee_range->currency_range }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="h-100">
                                        <input type="text" class="form-control input-field"
                                               name="number_grade11" id="number_grade11"
                                               wire:model.lazy="number_grade11"
                                ...
                                <div class="col-lg-6 mobile-marg-2">
                                    <div class="h-100">
                                        <select class="h-100 text-start form-control input-field"
                                                id="fees_grade11" name="fees_grade11" wire:model="fees_grade11"
                                                aria-label="">
                            ...
                            <div @class(['d-none'=>$curriculum_id !='2'])>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6 mobile-marg-2">
                                        <div class="h-100">
                                            <select class="h-100 text-start form-control input-field"
                                                    id="grade_13_fee" name="grade_13_fee" wire:model="grade_13_fee"
                                                    aria-label="">
