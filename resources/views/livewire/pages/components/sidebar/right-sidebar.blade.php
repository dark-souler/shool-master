    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <ul class="sidebar-ul">
                ...
                <li class="mb-2"><a @class(['a-underline blue','light-blue' => Route::is('admin.school.join.universityEvents.workshop')])
                                    href="{{route('admin.school.join.universityEvents.workshop')}}">@lang('Workshop')</a></li>
                <li class="mb-2"><a @class(['a-underline blue','light-blue' => Route::is('admin.school.join.universityEvents.studentForADay')])
                                    href="{{route('admin.school.join.universityEvents.studentForADay')}}">@lang('Student for a day')</a></li>
                <li class="mb-2"><a @class(['a-underline blue','light-blue' => Route::is('admin.school.join.universityEvents.compitition')])
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <ul class="sidebar-ul" x-data="{}">
                ...
                @endforeach
                    <li class="mb-2"><a @class(['a-underline blue']) @click="$wire.emit('showShareEventModal')"
                                        href="javascript:void(0)">
                            @lang("Share Event")</a></li>
                    <li class=""><a @class(['a-underline blue','light-blue' => Route::is('admin.school.inviteToEvent')])
                                        href="{{route('admin.school.inviteToEvent')}}">
                            @lang("Invite to Event")</a></li>
            </ul>
        </div>
    </div>
</div>
