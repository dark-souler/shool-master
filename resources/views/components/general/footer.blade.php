...
<footer class="bg-blue">
    <div class="container">
        <div class="row py-4">
            <div class="col-12 col-md-3">
                <ul class="list-group">
                    ...
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top World Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top North America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Latin America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Europe America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Asia America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Africa America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Arab America Universities')
                        </a>
                    </li>
                    <li class="list-group-item borderless">
                        <a href="javascript:void(0)" class="text-decoration-none text-white coming-soon">
                            @lang('Top Oceania America Universities')
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-12 col-md-3 mt-4 my-md-0">
                <ul class="list-group">
                    <li class="list-group-item h3 fw-bold borderless mb-4">
                        Follow Us
                        <div class="decorative-spacer mt-2"></div>
        ...
        <div class="row my-3 align-items-center">
            <div class="col-12 col-md-3  py-2 py-md-0 text-center text-md-start">
            ...
            <div class="col-12 col-md-3 py-2 px-0">
                <ul class="w-100 list-group list-group-horizontal justify-content-center justify-content-md-end">
